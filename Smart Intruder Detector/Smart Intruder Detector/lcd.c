...
*modify to p18f2550.h By ANG JIA YI.......
*******************************************************************************/
...
#define LCD_E			PORTBbits.RB3		// E clock pin is connected to RB5	
#define LCD_RS			PORTBbits.RB2 	// RS pin is used for LCD to differentiate data is command or character
...
*
*******************************************************************************/
void lcd_putstr(rom const char* csz_string)
{
...
void send_lcd_data(unsigned char b_rs, unsigned char uc_data)
{
		...
		uc_pre_portd = PORTB;			//keep PORTD original value
		// 4-bit Mode.
	...
	PORTB = uc_pre_portd; //restore PORTD original value
}
